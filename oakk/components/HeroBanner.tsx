...
export default function HeroBanner() {
  return (
    <div className="w-full bg-[#0C1D36] text-white rounded-2xl p-6 sm:p-8 shadow-md relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl">
        <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-white/10 text-blue-100 text-xs font-medium mb-3 backdrop-blur-xs">
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4 max-w-md pt-2 border-t border-white/10">
          <div className="bg-white/5 rounded-xl p-2.5 sm:p-3 border border-white/10 text-center">
